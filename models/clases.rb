...
class GameController
  ...
  #Method to determine in which state and substate the game is currently in.
  def index
...
#Creates an object game with the initial parameters for the game and the player (state
#, substate, money, life, fights and respect).
